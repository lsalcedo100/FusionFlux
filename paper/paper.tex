...
to 0.018 and ITPA20-IL by up to 0.022, enough to reorder ITPA20 against
IPB98(y,2) per label, so the substitution is not free and is not modelled here.
Sec.~S13 of the Supplementary Material measures what it costs and why a shape
model is the wrong way to find out, including the rows where the measured ratio
falls below unity and the one label, PBX-M, whose indented boundary explains
them.
...
\textbf{One hundred and ten} of the numbers printed above, and \textbf{one
