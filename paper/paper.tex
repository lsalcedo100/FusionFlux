...
observed error of any fit tested here at that cut, with no within-surface
hyperparameter to tune, on a surface selected after those scores were seen; (v) a Gaussian-process experiment
...
unaided. It nonetheless beats the unconstrained fit at all 8 well-powered cuts,
and descriptively at all 15 cuts in the size sweep when the underpowered ones
are included, since a constraint the data satisfies on average still stops the fit
...
0.001 in in-sample log-RMSE and was the best-scoring option at the size cut, on
a constraint rung chosen after those scores had been seen.
...
ITER-size-matched cut, cost 0.001 in sample, and has no within-surface
hyperparameter to tune. That rung
